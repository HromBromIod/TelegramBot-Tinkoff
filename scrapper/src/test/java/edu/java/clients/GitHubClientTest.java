...
class GitHubClientTest {
    static final String BODY_REQUEST = "{\"name\": \"repa\"}";
    static final String URL = "/repos/Test_Client/Repository";
    ...
    public void regularWorkTest() {
        ...
        Repository rep = gitHubClient.getRepository("Test_Client", "Repository");
        assertEquals("repa", rep.name());
    }
    ...
    public void linkErrorTest() {
        ...
        String message = "";
        try {
            gitHubClient.getRepository("Wrong_Test_Client", "Repository");
    ...
    public void serverErrorTest() {
        ...
        String message = "";
        try {
            gitHubClient.getRepository("Test_Client", "Repository");
        } catch (ResponseStatusException e) {
            message = e.getMessage();
        }
